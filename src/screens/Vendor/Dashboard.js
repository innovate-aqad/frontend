    ...
    <ScrollView>
      <View className="flex flex-col pb-20">
        ...
        <View className="p-3 px-5 gap-y-2">
          <TouchableOpacity onPress={()=>nav.navigation.navigate("searchFilter")} className="flex flex-row items-center justify-between bg-white rounded-[10px] p-2 px-4">
            <Text style={{color: lightGray, fontFamily: ROBOTO.RobotoRegular}}>
              Search...
            </Text>
