      ...
      <ScrollView keyboardShouldPersistTaps="handled">
        <View className="flex flex-col p-4 ">
          ...
          <View style={styles.container1}>
            ...
            <View className="flex flex-row items-center gap-x-2">
              <Text className={'text-[10px] text-[#f96900]'} style={{fontFamily: POPPINS.PoppinsSemiBold}}>Verify</Text>
              <MaterialIcons
                name={'edit'}
                style={{
          ...
          <View className="mt-2">
            ...
            <View className="flex flex-row items-center p-2 w-full bg-white rounded-[10px] py-0">
              ...
              <View className="flex flex-row items-center justify-between w-[73%]">
                ...
                <View className="flex flex-row items-center gap-x-2">
                  <Text
                    className={'text-[10px] text-[#21d59b]'}
                    style={{fontFamily: POPPINS.PoppinsSemiBold}}>
                    Verified
                  </Text>
                  <MaterialIcons
                    name={'edit'}
        ...
        <View className="relative w-full px-4 mb-12">
          <CustomButton
            text={'SAVE CHANGE'}
            onPress={() =>
              console.warn('edit user function go to save changes')
            }
          />
        </View>
      </ScrollView>
