...
// AntDesign
export default function retailerIntegrationSettings() {
  ...
  return (
    <View style={{backgroundColor: screenBackground}}>
      ...
      <View className="flex flex-col items-center justify-center mt-8">
        <Image source={require("../../../Assets/image/retailer/phoneBoot.png")} style={{height:130,width:142}} />
          ...
          <View style={styles.mainView}>
            <View className="flex flex-row justify-between">
                <View className="flex flex-row">
                    <Image source={require('../../../Assets/image/retailer/pos.png')} 
                    style={{height:18,width:18}} />
                    <Text style={styles.heading}>POS Integration</Text>
                </View>
                <ToggleSwitch
                  isOn={isEnabled}
