...
import square_plus from '../../Assets/image/square_plus.svg';
// import minu from '../../Assets/image/square_minus.svg';
import minus from '../../Assets/image/square_minus.svg';
import {
  blue,
  flexTradButtonColor,
  grayColor,
          ...
          <Card.Content className="py-0 pr-2">
            <View style={styles.header}>
              ...
              <IconButton
                icon={() =>
                  isOpen ? (
                    <SvgUri source={minus} width={24} />
                  ) : (
                    <SvgUri source={square_plus} width={24} />
                  )
                }
                className="relative right-[-12px]"
                onPress={() => toggleCard(item.id)}
