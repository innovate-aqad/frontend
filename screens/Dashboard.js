...
const chartConfig = {
  ...
  color: (opacity = 1) => `orange`, // orange color
  labelColor: (opacity = 1) => `#999`, // orange color
  style: {
    borderRadius: 16,
  },
  propsForDots: {
    ...
    <View className="flex flex-col pb-20">
      ...
      <View className="p-3 px-5 gap-y-3">
        <View style={styles.container}>
          ...
          <View style={{ backgroundColor: '#fff', padding: 12, borderRadius: 10, shadowColor: '#000', shadowOpacity: 0.2,shadowRadius: 10,display:"flex",flexDirection: 'row' }}>
              <View>
                ...
                <View className="flex flex-row">
                  <Text style={{fontSize: 8,color: '#999',color:"green",marginRight: 2}}>2.3%</Text>
                  <Text style={{fontSize: 8,color: '#999',}}>|</Text>
                  <Text style={{fontSize: 8,color: '#999', marginLeft: 2}}>than last year</Text>
          ...
          <View style={{ backgroundColor: '#fff', padding: 12, borderRadius: 10, shadowColor: '#000', shadowOpacity: 0.2,shadowRadius: 10,display:"flex",flexDirection: 'row' }}>
              <View>
                 <Text style={{ fontSize: 12,fontWeight: 'bold',marginBottom: 8,}}>SKU</Text>
                <View className="flex flex-row">
                  <Text style={{ fontSize: 14,color: '#666',fontWeight:"bold"  }}>14570</Text>
                  <Text style={{ fontSize: 8,color: '#666',marginLeft:2  }}>Units</Text>
                </View>
                <View className="flex flex-row">
                  <Text style={{fontSize: 8,color: '#999',color:"red",marginRight: 2}}>2.3%</Text>
                  <Text style={{fontSize: 8,color: '#999',}}>|</Text>
                  <Text style={{fontSize: 8,color: '#999', marginLeft: 2}}>than last year</Text>
          ...
          <View style={{ backgroundColor: '#fff', padding: 12, borderRadius: 10, shadowColor: '#000', shadowOpacity: 0.2,shadowRadius: 10,display:"flex",flexDirection: 'row' }}>
              <View>
                 <Text style={{ fontSize: 12,fontWeight: 'bold',marginBottom: 8,}}>Pending Orders</Text>
                <View className="flex flex-row">
                  <Text style={{ fontSize: 14,color: '#666',fontWeight:"bold"  }}>300</Text>
                </View>
                <View className="flex flex-row">
                  <Text style={{fontSize: 8,color: '#999',color:"red",marginRight: 2}}>2.3%</Text>
                  <Text style={{fontSize: 8,color: '#999',}}>|</Text>
          ...
          <View style={{ backgroundColor: '#fff', padding: 12, borderRadius: 10, shadowColor: '#000', shadowOpacity: 0.2,shadowRadius: 10,display:"flex",flexDirection: 'row' }}>
              <View>
                 <Text style={{ fontSize: 12,fontWeight: 'bold',marginBottom: 8,}}>Cancelled Orders</Text>
                <View className="flex flex-row">
                  <Text style={{ fontSize: 14,color: '#666',fontWeight:"bold"  }}>105</Text>
                </View>
                <View className="flex flex-row">
                  <Text style={{fontSize: 8,color: '#999',color:"green",marginRight: 2}}>2.3%</Text>
                  <Text style={{fontSize: 8,color: '#999',}}>|</Text>
        ...
        <View className="flex flex-row h-fit items-center w-[100%] !justify-between mt-2 px-0 text-black bg-white rounded-xl shadow">
          <View className="py-1">
            <View className="flex flex-col  w-100 pl-6 pt-4 pb-5">
              <Text style={{ fontSize: 15, fontWeight: 'bold' }}>Performance Matrix</Text>
            </View>
            <BarChart
                data={data}
                width={300}
